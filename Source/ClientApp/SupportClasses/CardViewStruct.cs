    ...
    public static class CardViewStruct
    {
        ...
        public const string MainStackPanel = "MainStackPanel";
            public const string FirstLineDockPanel = "FirstLineDockPanel";
                public const string CreatedDateBorder = "CreatedDateBorder";
                    public const string CreatedDateDockPanel = "CreatedDateDockPanel";
                        public const string CreatedDateTextBlock = "CreatedDateTextBlock";
                        public const string CreatedDateTextBox = "CreatedDateTextBox";
                public const string DocTypeBorder = "DocTypeBorder";
                    public const string DocTypeDockPanel = "DocTypeDockPanel";
                        public const string DocTypeTextBlock = "DocTypeTextBlock";
                        public const string DocTypeTextBox = "DocTypeTextBox";
                public const string StateBorder = "StateBorder";
