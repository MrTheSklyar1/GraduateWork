...
insert into Tasks values (@TaskID2, @AdminID, 'Admin A.', @AdminID, 'Admin A.',SYSDATETIME(), @DocID, @WorkID, 'Test doc', NULL);
insert into Tasks values (@TaskID, @AdminID, 'Admin A.', @BuhUchet, 'Бухгалтерский учет',SYSDATETIME(), @DocID, @WorkID, 'Test doc2', NULL);
insert into Tasks values (@TaskID3, @AdminID, 'Admin A.', @HR, 'Кадры',SYSDATETIME(), @DocID, @WorkID, 'Test doc3', NULL);
insert into Tasks values (@TaskID4, @AdminID, 'Admin A.', @BuhUchet, 'Бухгалтерский учет',SYSDATETIME(), @DocID, @CompletedID, 'Test doc4', NULL);
