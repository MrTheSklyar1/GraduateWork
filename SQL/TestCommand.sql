...
insert into Tasks values (@TaskID2, '2018-03-00001', @AdminID, 'Admin A.', @AdminID, 'Admin A.',SYSDATETIME(), @DocID, @WorkID,'Test doc', NULL, NULL, NULL, 0);
insert into Tasks values (@TaskID, '2018-03-00002', @AdminID, 'Admin A.', @BuhUchet, 'Бухгалтерский учет',SYSDATETIME(), @DocID, @WorkID,'Test doc2', 'Resp 2', NULL, NULL, 0);
insert into Tasks values (NEWID(), '2018-03-00003', @AdminID, 'Admin A.', @HR, 'Кадры',SYSDATETIME(), @DocID, @WorkID, 'Test doc3', 'Resp 3', NULL, NULL, 0);
insert into Tasks values (@TaskID4, '2018-03-00004', @AdminID, 'Admin A.', @BuhUchet, 'Бухгалтерский учет',SYSDATETIME(), @DocID, @CompletedID, 'Test doc4', 'Resp 4', @AdminID, SYSDATETIME(), 0);
insert into Tasks values (@TaskID5, '2018-03-00005', @AdminID, 'Admin A.', @BuhUchet, 'Бухгалтерский учет',SYSDATETIME(), @DocID, @CompletedID, 'Test doc5', 'Resp 5', @AdminID, SYSDATETIME(), 0);
insert into Tasks values (@TaskID6, '2018-03-00006', @AdminID, 'Admin A.', @AdminID, 'Admin A.',SYSDATETIME(), @DocID, @CancelledID, 'Test doc6', 'Resp 6', @AdminID, SYSDATETIME(), 0);
