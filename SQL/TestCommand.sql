...
insert into Tasks values (@TaskID2, @AdminID, 'Admin A.', @AdminID, 'Admin A.',SYSDATETIME(), @DocID, @WorkID,'Test doc', NULL, NULL, NULL);
insert into Tasks values (@TaskID, @AdminID, 'Admin A.', @BuhUchet, 'Бухгалтерский учет',SYSDATETIME(), @DocID, @WorkID,'Test doc2', 'Resp 2', NULL, NULL);
insert into Tasks values (@TaskID3, @AdminID, 'Admin A.', @HR, 'Кадры',SYSDATETIME(), @DocID, @WorkID, 'Test doc3', 'Resp 3', NULL, NULL);
insert into Tasks values (@TaskID4, @AdminID, 'Admin A.', @BuhUchet, 'Бухгалтерский учет',SYSDATETIME(), @DocID, @CompletedID, 'Test doc4', 'Resp 4', NULL, NULL);
insert into Tasks values (@TaskID5, @AdminID, 'Admin A.', @BuhUchet, 'Бухгалтерский учет',SYSDATETIME(), @DocID, @CompletedID, 'Test doc5', 'Resp 5', @AdminID, NULL);
