...
insert into Tasks values (@TaskID2, '2018-03-0001', @AdminID, 'Admin A.', @AdminID, 'Admin A.',SYSDATETIME(), @DocID, @WorkID,'Test doc', NULL, NULL, NULL);
insert into Tasks values (@TaskID, '2018-03-0002', @AdminID, 'Admin A.', @BuhUchet, 'Бухгалтерский учет',SYSDATETIME(), @DocID, @WorkID,'Test doc2', 'Resp 2', NULL, NULL);
insert into Tasks values (@TaskID3, '2018-03-0003', @AdminID, 'Admin A.', @HR, 'Кадры',SYSDATETIME(), @DocID, @WorkID, 'Test doc3', 'Resp 3', NULL, NULL);
insert into Tasks values (@TaskID4, '2018-03-0004', @AdminID, 'Admin A.', @BuhUchet, 'Бухгалтерский учет',SYSDATETIME(), @DocID, @CompletedID, 'Test doc4', 'Resp 4', NULL, SYSDATETIME());
insert into Tasks values (@TaskID5, '2018-03-0005', @AdminID, 'Admin A.', @BuhUchet, 'Бухгалтерский учет',SYSDATETIME(), @DocID, @CompletedID, 'Test doc5', 'Resp 5', @AdminID, SYSDATETIME());
