...
--insert into Tasks values (@TaskID4, '2018-03-0004', @AdminID, 'Admin A.', @BuhUchet, 'Бухгалтерский учет',SYSDATETIME(), @DocID, @CompletedID, 'Test doc4', 'Resp 4', @AdminID, SYSDATETIME());
...
--insert into Tasks values (@TaskID6, '2018-03-0006', @AdminID, 'Admin A.', @AdminID, 'Admin A.',SYSDATETIME(), @DocID, @CancelledID, 'Test doc6', 'Resp 6', @AdminID, SYSDATETIME());
--insert into Files values (@TaskID6, 'eb8cb0a4-fc1d-4bdc-988f-dfe702178cf4', 'Бла бла бла.docx');
insert into Files values (@TaskID, 'eb8cb0a4-fc1d-4bdc-988f-dfe702178884', 'Бла бла бла1.docx');